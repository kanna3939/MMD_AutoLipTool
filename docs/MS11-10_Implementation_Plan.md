...
- `README.md` の版数を `Ver 0.3.7.1` へ更新
- `pyproject.toml` の version を `0.3.7.1` へ更新
- 主要仕様文書・roadmap の baseline version を `Ver 0.3.7.1` へ更新
...
- `repo_milestone.md` に `Ver 0.3.7.1` 同期メモを追加
...
MS11-10 は、
**MS11 系の最終整合を `Ver 0.3.7.1` として文書へ反映し、FIX7 まで含めた closeout 状態を MS12 へ渡せる形に整えるための sync タスク**
である。
